package emcorp.studio.pickpackgo.adapter;
...
import emcorp.studio.pickpackgo.utils.ViewAnimation;
...
public class AdapterListOrders extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListOrders(Context context, List<Social> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public OriginalViewHolder(View v) {
            ...
            isi = (TextView) v.findViewById(R.id.tvExpand);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.isi.setText("Bin : "+p.bin_name);
