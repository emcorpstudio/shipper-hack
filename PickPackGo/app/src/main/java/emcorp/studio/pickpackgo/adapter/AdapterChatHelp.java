...
import emcorp.studio.pickpackgo.model.Message;

import java.util.ArrayList;
import java.util.List;

public class AdapterChatHelp extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterChatHelp(Context context) {
        ctx = context;
    }
